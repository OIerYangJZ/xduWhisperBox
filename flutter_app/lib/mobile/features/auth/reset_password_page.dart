...
class _ResetPasswordPageState extends ConsumerState<ResetPasswordPage> {
  ...
  Future<void> _handleSendCode() async {
    ...
    if (!_isStudentEmail(email)) {
      setState(() {
        _errorMessage = '仅支持 @stu.xidian.edu.cn 学生邮箱';
      });
      return;
    }
  ...
  bool _isStudentEmail(String value) {
    return value.trim().toLowerCase().endsWith('@stu.xidian.edu.cn');
  }
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (!_isStudentEmail(value)) {
                          return '仅支持 @stu.xidian.edu.cn 学生邮箱';
                        }
                        return null;
                      },
                    ),
